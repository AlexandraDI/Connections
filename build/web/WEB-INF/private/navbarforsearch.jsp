        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <c:if test="${not empty me and empty administrator}">
                    ...
                    <li class="nav-item" ><a class="nav-link smooth-scroll" href="${pageContext.request.contextPath}/conversations">Conversation</a></li>

                    <li class="nav-item" ><a class="nav-link smooth-scroll"href="${pageContext.request.contextPath}/applications">Ad</a></li> 
                    ...
                    <li class="nav-item dropdown" >
                        ...
                        <div class="dropdown-menu dropdown-cust" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/?">Change e-mail</a>
                            <a class="dropdown-item" href="${pageContext.request.contextPath}/?">Privacy options</a>
                        </div>
                    </li>
