<%-- 
    Document   : service
    Created on : Aug 28, 2018, 3:01:28 PM
    Author     : alex
--%>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="client-cont wow fadeInUp" data-wow-delay="0.1s">
                    <img src="${pageContext.request.contextPath}/img/client/avatar-6.jpg" class="img-fluid" alt="">
                    <h5>Leesa len</h5>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="client-cont wow fadeInUp" data-wow-delay="0.3s">
                    <img src="${pageContext.request.contextPath}/img/client/avatar-2.jpg" class="img-fluid" alt="">
                    <h5>Dec Bol</h5>
                    <h6>TEMS founder</h6>
                    <i class="fa fa-quote-left"></i>
