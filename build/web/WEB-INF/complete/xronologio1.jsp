<%-- 
    Document   : details
    Created on : Sep 5, 2018, 12:23:05 AM
    Author     : alex
--%>
          ...
          <div class="col-md-3">                                     
                ...
                <div class="thumbnail-blogs">
                    <div class="caption">
                      <a href="${pageContext.request.contextPath}/profile">   
                          ...
                          <center><img src="img/news/man2.jpg" alt="..." style="width:60%;"></center>
                </div>
                </div>    
             ...
             <!-- </div>          -->                            
               ...
               <div class="ad-box-sn">              
                ...
                <div class="card">
                 &nbsp;                                                      
                 <center><h5>Leave an Article</h5></center>
                 <input type="text" name="article" placeholder="Share an article, photo, video or idea" class="form-control"><br>
                 <center> <input type="file" class="btn btn-general btn-green" style="width: 100%;" name="pic" accept="image/*"></center>&nbsp;
                 <button class="btn btn-general btn-green" style="width: 100%;" role="button">Post</button>
