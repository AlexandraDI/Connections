    ...
    <body id="page-top">
       ...
       ======================================================-->       
        ...
        <div id="home-p" class="home-p  text-center"> 
            <div class="container">
                <h1 class="wow fadeInUp" data-wow-delay="0.1s">Change Email</h1>
            </div>
        </div>  
                    ...
                    <div class="col-md-10 main-login main-center">
                        <form method="post" id="login-form" action="">
                            <div class="form-group">
                                <label for="email" class="cols-sm-2 control-label">Current Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="cols-sm-10">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
                                        <input type="text" class="form-control" name="newemail1" id="newemail1"  placeholder="Enter your new email" required="true"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="email" class="cols-sm-2 control-label">Confirm New Email</label>
                                <div class="cols-sm-10">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
                                        <input type="text" class="form-control" name="newemail2" id="newemail2"  placeholder="Retype your new Email" required="true"/>
                                    </div>
                                </div>
                            </div>
